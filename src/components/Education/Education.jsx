  ...
  return (
    ...
    >
      ...
      <div className="relative">
        {/* Vertical line - Fixed to always be visible */}
        ...
        {education.map((edu, index) => (
          ...
          >
            {/* Timeline Circle - Fixed logo size */}
            ...
            {/* Content Section - Original format */}
            <div
            ...
            >
              {/* Flex container for image and text - Original */}
              <div className="flex items-center space-x-6">
                {/* School Logo/Image - Original size with object-contain */}
                <div className="w-24 h-16 sm:w-28 sm:h-20 bg-white rounded-md overflow-hidden flex items-center justify-center p-2">
                  <img
                    src={edu.img}
                    alt={edu.school}
                    className="w-full h-full object-contain"
                ...
                {/* Degree, School Name, and Date - Original */}
